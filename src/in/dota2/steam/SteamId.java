...
public class SteamId {
     ...
     * @throws Dota2Exception if the community ID is to small
     */
    public static String convertCommunityIdToSteamId(long communityId)
        ...
        if(steamId2 <= 0) {
            throw new Dota2Exception("SteamID " + communityId + " is too small.");
        }
     ...
     * @throws Dota2Exception if the SteamID doesn't have the correct
     *         format
     */
    public static long convertSteamIdToCommunityId(String steamId)
            throws Dota2Exception {
        if(steamId.equals("STEAM_ID_LAN") || steamId.equals("BOT")) {
            throw new Dota2Exception("Cannot convert SteamID \"" + steamId + "\" to a community ID.");
        }
        if(steamId.matches("^STEAM_[0-1]:[0-1]:[0-9]+$")) {
            ...
            throw new Dota2Exception("SteamID \"" + steamId + "\" doesn't have the correct format.");
        }
    }
     ...
     * @throws Dota2Exception if the Steam ID data is not available,
     ...
     */
    public void fetchData() throws Dota2Exception {
        try {
            XMLData profile = new XMLData(this.getBaseUrl() + "?xml=1");

            if(profile.hasElement("error")) {
                throw new Dota2Exception(profile.getString("error"));
            }
            ...
            if(profile.hasElement("privacyMessage")) {
                throw new Dota2Exception(profile.getString("privacyMessage"));
            }
     ...
     *         data
     */
    private void fetchFriends() throws Dota2Exception {
        try {
     ...
     *         data
     */
    private void fetchGames() throws Dota2Exception {
        try {
     ...
     * @throws Dota2Exception if the user does not own this game or it
    ...
    public GameStats getGameStats(Object id)
        ...
        if(!game.hasStats()) {
            throw new Dota2Exception("\"" + game.getName() + "\" does not have stats.");
        }
     ...
     * @throws Dota2Exception if the user does not own the game or no
    ...
    private SteamGame findGame(Object id)
        ...
        if(game == null) {
            ...
            throw new Dota2Exception(message);
        }
