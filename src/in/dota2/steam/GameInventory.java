...
import in.dota2.steam.Dota2BetaInventory;
import in.dota2.steam.Dota2Inventory;
...
public class GameInventory {
     ...
     * @throws WebApiException on Web API errors
     */
    public void fetch() throws Dota2Exception {
        try {
            ...
            for(int i = 0; i < itemsData.length(); i ++) {
                ...
                if(itemData != null) {
                    try {
                        ...
                        if (e.getCause() instanceof Dota2Exception) {
                            throw (Dota2Exception) e.getCause();
                        } else {
     ...
     * @throws Dota2Exception if the item schema cannot be fetched
     */
